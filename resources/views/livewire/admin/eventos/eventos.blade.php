<x-app-layout>
    ...
    <div class="p-2 bg-white">
        <h2 class="text-2xl py-2 text-fondo-verde font-extrabold text-center">Eventos</h2>
        <div>
            @can('admin')
            <h2 class="text-2xl py-2 text-fondo-verde font-extrabold">
                <x-html.link href="{{ route('eventos.create') }}" text="Crear evento" isButton="true" class="inline-block mb-2 ml-4" />
            </h2>
            @endcan
                    ...
                    <div class="-my-2 overflow-x-auto">
                        <div class="py-2 align-middle">
                            <div class="p-3 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                @include('livewire/admin/eventos/listar-eventos')
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        ¿Estás totalmente seguro/a de eliminar este evento?
