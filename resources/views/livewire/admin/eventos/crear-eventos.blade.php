<x-app-layout>
    ...
    <div class="bg-white p-6 m-2">
        ...
        <div class="m-3 p-6 bg-gray-50 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <h2 class="text-2xl py-2 text-fondo-verde font-extrabold">Nuevo evento</h2>
            <div class="flex flex-col">
                <form method="post" action="{{ route('eventos.store') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    @csrf
                    <div class="space-x-2">
                        <div class="mb-3 grid grid-cols-2 space-x-2">
                            ...
                            <div class="mb-3">
                                <label for="fecha_evento" class="block font-bold text-gray-700">Fecha de
                                    publicación</label>
                                <input type="date" name="fecha_evento" id="fecha_evento" class="w-full rounded-xl text-gray-500 border-gray-300" value="">
                                @error('fecha_evento')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="hora" class="block font-bold text-gray-700">Fecha de
                                    publicación</label>
                                <input type="time" name="hora" id="hora" class="w-full rounded-xl text-gray-500 border-gray-300" value="">
                                @error('hora')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="flex space-x-2">
                            <div class="m-3 grid grid-cols-2 gap-8">
                                <x-forms.button type="submit" text="Crear evento" />
