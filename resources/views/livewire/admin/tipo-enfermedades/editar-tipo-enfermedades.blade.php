<x-app-layout>
    @section('title', 'Editar tipo de enfermedad')
    <div class="p-2 bg-white">
        <h2 class="text-2xl py-2 text-fondo-verde font-extrabold text-center">Tipo de enfermedades</h2>
        <div class="m-3 w-1/3 p-2 bg-gray-50 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <h2 class="text-2xl py-2 text-fondo-verde font-extrabold">Modificar tipo de enfermedad</h2>
            <div class="flex flex-col">
                <form action="{{ route('tipos-enfermedades.update', $tipo_enfermedad) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="mb-3" style="margin-left: 0.5%">
                        ...
                        <input type="text" name="categoria_enfermedad" id="categoria_enfermedad"
                            ...
                            value="{{ old('categoria_enfermedad', $tipo_enfermedad->categoria_enfermedad) }}">
                    ...
                    <div class="w-full mb-3">
                        ...
                        <textarea name="descripcion" id="descripcion"
                            class="w-full rounded-xl text-gray-500 border-gray-300">{{ old('descripcion', $tipo_enfermedad->descripcion) }}</textarea>
                        @error('descripcion')
                            <small class="text-red-500">* {{ $message }}</small>
                        @enderror
                    </div>
