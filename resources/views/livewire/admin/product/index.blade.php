<x-app-layout>
    ...
    <div class="p-2 bg-white">
        <h2 class="text-2xl py-2 text-fondo-verde font-extrabold text-center">Productos</h2>

        <div class="flex flex-col">
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="p-3 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table id="productos" class="display compact" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{$producto->slug}}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        ¿Estás totalmente seguro/a de eliminar este producto? Esta acción no se puede
                                        deshacer.
                                    </p>
                                </div>
                            </div>
