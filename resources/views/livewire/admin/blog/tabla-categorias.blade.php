    ...
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div class="p-2 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table id="categoria_blog" class="display compact" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#categoria_blog').DataTable({
                "paging": true,
                "lengthChange": true,
                "searching": true,
                "ordering": true,
