<table id="tipo_eventos" class="display compact" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                    <h2 class="text-2xl text-fondo-verde font-extrabold" style="margin-right: 10px">
                        <x-html.link href="{{ route('tipo-eventos.edit', $tipo) }}" text="Editar" isButton="true" class="inline-block mb-2 ml-1" />
                    </h2>
                    <h2 class="mb-2">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tipo_eventos').DataTable({
                "paging": true,
                "lengthChange": true,
                "searching": true,
                "ordering": true,
