...
<div class="m-3 w-1/3 p-2 bg-gray-50 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
    <h2 class="text-2xl py-2 text-fondo-verde font-extrabold">Nuevo tipo de evento</h2>
    <div class="flex flex-col">
        <form action="{{ route('tipo-eventos.store') }}" method="POST">
            ...
            <div class="w-full mb-3">
                ...
                <input type="text" name="tipo_evento" id="tipo_evento" class="w-full rounded-xl text-gray-500 border-gray-300" value="">
                @error('tipo_evento')
                <small class="text-red-500">* {{ $message }}</small>
                @enderror
            </div>
            <div class="w-full mb-3 grid grid-cols-2 gap-4">
                <x-forms.button type="submit" text="Crear tipo de evento" />
