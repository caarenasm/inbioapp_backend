    ...
    <div class="p-2 bg-white pt-6 m-2">
        ...
        <div class="m-3 p-2 bg-gray-50 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            ...
            <div class="flex flex-col">
                <form method="post" action="{{ route('recetas.update', $receta) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="space-x-2 ">
                        <div class="mb-3 grid grid-cols-2 space-x-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="titulo" id="titulo" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('titulo', $receta->titulo) }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="slug" id="slug" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('slug', $receta->slug) }}" readonly>
                                @error('slug')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="seo_titulo" id="seo_titulo" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('seo_titulo', $receta->seo_titulo) }}">
                                @error('seo_titulo')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="seo_descripcion" id="seo_descripcion" class="w-full rounded-xl text-gray-500 border-gray-300">{{ old('seo_descripcion', $receta->seo_descripcion) }}</textarea>
                            ...
                            <div class="mb-3">
                                <label for="fecha_publicacion" class="block font-bold text-gray-700">Fecha de
                                    publicación</label>
                                <input type="date" name="fecha_publicacion" id="fecha_publicacion" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('fecha_publicacion', $receta->fecha_publicacion) }}">
                                @error('fecha_publicacion')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            <div class="flex-grow mb-3">
                                <label><input type="radio" name="publicacion" value="0" required {{ old('publicacion', $receta->publicacion) == '0' ? 'checked' : '' }}>
                                    Borrador</label>
                                <label><input type="radio" name="publicacion" value="1" {{ old('publicacion', $receta->publicacion) == '1' ? 'checked' : '' }}>
                                    Publicación</label>
                                @error('publicacion')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            ...
                            <div class="w-full mb-3">
                                ...
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                                <textarea name="preparacion" id="preparacion" class="w-full rounded-xl text-gray-500 border-gray-300">{{ old('preparacion', $receta->preparacion) }}</textarea>

                            </div>

                            <div class="mb-3">
                                <label for="caloria" class="block font-bold text-gray-700">Caloria</label>
                                <input type="number" name="caloria" id="caloria" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('caloria', $receta->caloria) }}">
                                @error('caloria')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="grasa" id="grasa" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('grasa', $receta->grasa) }}">
                                @error('grasa')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="proteina" id="proteina" class="w-full rounded-xl text-gray-500 border-gray-300" value="{{ old('proteina', $receta->proteina) }}">
                                @error('price')
                                <small class="text-red-500">* {{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-3">
                                <div class="col">
                                    <div class="image-wrapper">
                                        <img id="picture" src="{{ asset('./imagenes/recetas/' . old('imagen_url', $receta->imagen_url)) }}" alt="{{ old('imagen_url', $receta->imagen_url) }}">
                                    </div>
                                </div>
