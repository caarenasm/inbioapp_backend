<x-app-layout>
    ...
    <div class="p-2 bg-white pt-6 m-2">
        ...
        <div class="m-3 p-2 bg-gray-50 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <h2 class="text-2xl py-2 text-fondo-verde font-extrabold">Modificar receta</h2>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-3">
                                <div class="col">
                                    <div class="image-wrapper">
                                        ...
                                        @else
                                            <img id="picture"
                                                src="{{ asset('./imagenes/recetas/placeholder.png') }}"
                                                alt="{{ old('imagen_url', $receta->imagen_url) }}">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div>
                                    <p class="font-bold text-sgray-700">Imagen principal de la receta</p>
