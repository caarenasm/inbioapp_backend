<x-app-layout>
    ...
    @section('title', 'Categoria del diario')

    <div class="p-2 bg-white">
        <h2 class="text-2xl py-2 text-fondo-verde font-extrabold text-center m-3">Categorías del diario</h2>
        <div class="p-2 bg-white">
            @can('admin')
                @include('livewire/admin/categorias-diarios/crear-categorias-diarios')
            @endcan
        </div>
        <div class="p-2 bg-white">
                ...
                <div class="-my-2 overflow-x-auto">
                    <div class="py-2 align-middle">
                        <div class="p-3 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            @include('livewire/admin/categorias-diarios/listar-categorias-diarios')
                        </div>
                    </div>
                </div>
            </div>
