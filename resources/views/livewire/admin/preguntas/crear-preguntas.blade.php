...
<div class="bg-white p-6 m-2">
    ...
    <div class="m-3 p-6 bg-gray-50 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        ...
        <div class="flex flex-col">
            <form method="post" action="{{ route('preguntas.store') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                <div class="space-x-2 w-auto">
                    <div class="mb-3 grid grid-cols-2">
                        <div class="m-3">
                            ...
                            <input type="text" name="pregunta" id="pregunta" class="w-full rounded-xl text-gray-500 border-gray-300" value="">
                            @error('pregunta')
                        ...
                        <div class="m-3">
                            <label><input type="radio" name="tipo_respuestas" value="1" required>Respuesta unica</label>
