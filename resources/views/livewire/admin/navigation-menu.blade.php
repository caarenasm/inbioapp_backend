<div class="flex-item border-t border-gray-300">
    ...
    @can('editar_admin_editor')
        ...
        <div class="flex-col p-1" x-data="{ openAlimentos : false }">
            <a class="border-b border-gray-300 p-1 block text-white" x-on:click="openAlimentos = openAlimentos !== true">
                <div class="inline-block w-5 relative top-1">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="head-side-cough"
                        class="svg-inline--fa fa-head-side-cough fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 512">
            ...
            <a class="border-b border-gray-300 p-1 block text-white" x-on:click="openAlimentos = openAlimentos !== true">
                <div class="inline-block w-5 relative top-1">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="utensils"
                        class="svg-inline--fa fa-utensils fa-w-13" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 416 512">
                        <path fill="currentColor"
    ...
    <div class="flex-col p-1" x-data="{ openProductos : false }">
        ...
        <div x-show="openProductos">
            @can('editar_admin_editor')
                <div class="p-1 mt-1">
                    <a href="{{ route('usuarios') }}" class="text-white">
                        Usuarios registrados
                    </a>
                </div>
            @endcan
            <div class="p-1">
                <a href="{{ route('informacion.index') }}" class="text-white">
                    Informacion del usuario y otros
                </a>
            </div>
        </div>
    </div>
