<x-app-layout>
    ...
    <div class="p-2 bg-white">
        <h2 class="text-2xl py-2 text-fondo-verde font-extrabold text-center">Ingredientes</h2>
        <div class="p-2 bg-white">
            <div class="flex flex-col">
                <div class="p-2 bg-white">
                    @can('admin')
                        @include('livewire/admin/ingredientes/crear-ingredientes')
                    @endcan
                </div>
                <div class="p-2 bg-white">
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto">
                            <div class="py-2 align-middle">
                                <div class="p-3 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    @include('livewire/admin/ingredientes/listar-ingredientes')
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">
                                                ¿Estás totalmente seguro/a de eliminar este ingrediente? Esta acción no
                                                se puede
                                                deshacer.
                                            </p>
                                        </div>
