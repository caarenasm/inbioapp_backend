<x-app-layout>
    ...
    @section('title', 'Crear Enfermedad')

    <div class="p-2 bg-white">
        <h2 class="text-2xl py-2 text-fondo-verde font-extrabold">Crear nueva enfermedad</h2>
        ...
        <div class="flex flex-col">
            ...
            <form action="">
                ...
                <div class="w-1/2 mb-3">
                    ...
                    <textarea name="description" id="description" style="width:630px;height: 150px" class="w-full rounded-xl text-gray-500 border-gray-300" value=""></textarea>
                    <!-- @error('name') -->
                    <small class="text-red-500"></small>
                    <!-- @enderror -->
                </div>
                ...
                <div class="w-1/2 mb-3">
                    ...
                    <select wire:model="selectedState" class="form-control">
                        <option value="" selected>Escoge la enfermedad</option>
